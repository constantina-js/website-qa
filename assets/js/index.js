...
function updateToggleIcon(isDarkMode, icon) {
    icon.setAttribute('fill', isDarkMode ? 'rgba(43, 43, 43, 1)' : '#E6E1DA')
    icon.setAttribute('d', isDarkMode ? moonPath : sunPath)
}
